...
class Mock {
    ...
    private val ALL = MotivationConstatants.PHRASEFILTER.ALL
    private val HAPPY = MotivationConstatants.PHRASEFILTER.HAPPY
    private val MORNING = MotivationConstatants.PHRASEFILTER.MORNING
    ...
    fun getPhrase(categoryId: Int): String {
        ...
        val randomPhrase = java.util.Random().nextInt(mListPhrases.size)

        return mListPhrases[randomPhrase].description
    }
